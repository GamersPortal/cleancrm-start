...
return [
    ...
    'messages' => [
        'widgetInvoiceSummaryDashboardTotalsFromDate.required_if' => trans('ip.validation_invoice_summary_from_date'),
        'widgetInvoiceSummaryDashboardTotalsToDate.required_if' => trans('ip.validation_invoice_summary_to_date'),
    ],
];