    ...
    <section class="content">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">@lang('ip.recent_quotes')</h3>
                    </div>
                    @if (count($quotes))
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">@lang('ip.recent_invoices')</h3>
                    </div>
                    @if (count($invoices))
                        <div class="box-body no-padding">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">@lang('ip.recent_payments')</h3>
                    </div>
                    @if (count($payments))
                        <div class="box-body no-padding">
